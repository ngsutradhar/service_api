...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        UserType::create(['user_type_name' => 'Agent']);          #8
        ...
        EmployeeCategory::create(['employee_category_name' => 'Owner']);            #1
        EmployeeCategory::create(['employee_category_name' => 'Manager']);          #2
        EmployeeCategory::create(['employee_category_name' => 'Agent']);            #3
        EmployeeCategory::create(['employee_category_name' => 'Supervisor']);       #4
        EmployeeCategory::create(['employee_category_name' => 'Accountant']);       #5
        EmployeeCategory::create(['employee_category_name' => 'Office Staff']);     #6
        EmployeeCategory::create(['employee_category_name' => 'Worker']);           #7
        ...
        Employee::create(['employee_name'=>'Sachin Tendulkar','employee_category_id'=>1,'guardian_name'=>'Barun Tendulkar',
        'dob'=>'1980-02-10', 'doj'=>'2024-02-10', 'sex'=>'M', 'address'=>'Mumbai','city'=>'Navi','district'=>'TEHERGR','state_id'=>2,
        'pin'=>'40000002','whatsapp_number'=>'7605887990','contact_number'=>'9163196112','email_id'=>'barrackporeacademyofit2014@gmail.com','qualification'=>'MCA',
        'bank_name'=>'State bank of india','account_number'=>'322175428','ifsc'=>'SBIN00645',]);

        Employee::create(['employee_name'=>'Oishi Sutradhar','employee_category_id'=>2,'guardian_name'=>'Nanda Gopal Sutradhar',
        'dob'=>'2023-03-05', 'doj'=>'2024-02-12', 'sex'=>'F', 'address'=>'Kolkata','city'=>'Navi','district'=>'TEHERGR','state_id'=>19,
        'pin'=>'700120','whatsapp_number'=>'9852147589','contact_number'=>'9163196112','email_id'=>'barrackporeacademyofit2014@gmail.com','qualification'=>'MCA',
        'bank_name'=>'State bank of india','account_number'=>'322175428','ifsc'=>'SBIN00645',]);
       ...
       /*  //working Days
        ...
        ,'email'=>'owner','password'=>"81dc9bdb52d04dc20036dbd8313ed055",'employee_id'=>1,'user_type_id'=>1,'organisation_id'=>1]);

         User::create(['user_name'=>'Nanda Gopal','mobile1'=>'7605887990','mobile2'=>'9163196112'
        ,'email'=>'ngsutradhar50@gmail.com','password'=>"81dc9bdb52d04dc20036dbd8313ed055",'employee_id'=>2,'user_type_id'=>1,'organisation_id'=>2]);

        CustomerCategory::create(['customer_category_name' => 'Normal Customer']);          #1
        CustomerCategory::create(['customer_category_name' => 'Corporate Customer']);          #2
        ...
        ServiceType::create(['service_name' => 'Daily']);             #2
        ServiceType::create(['service_name' => 'Weekly']);            #3
        ServiceType::create(['service_name' => 'Fortnightly']);       #4
        ServiceType::create(['service_name' => 'Monthly']);           #5
        ServiceType::create(['service_name' => 'Quarterly']);         #6
        ServiceType::create(['service_name' => 'Half yearly']);       #7
        ServiceType::create(['service_name' => 'Yearly']);            #8
        ServiceType::create(['service_name' => 'Other']);             #9
 

        Status::create(['status_name' => 'Order Done']);          #1
        Status::create(['status_name' => 'Job Under Process']);   #2
        Status::create(['status_name' => 'Job Done']);           #3

        Customer::create(['customer_name'=>'Aniruddha Ghosh','customer_category_id'=>1,
        'address'=>'Lat Bagan Barrackpore','city'=>'Barrackpore','district'=>'North 24 pgs',
        'pin'=>'700120','whatsapp_number'=>'9852147589','contact_number'=>'9163196112','email_id'=>'aniruddha@gmail.com','state_id'=>19,'organisation_id'=>1]);

        Customer::create(['customer_name'=>'Pintu Das','customer_category_id'=>1,'address'=>'Stalin Nagar Barrackpore','city'=>'Barrackpore','district'=>'North 24 pgs','pin'=>'700120','whatsapp_number'=>'9852147442','contact_number'=>'9163196112','email_id'=>'pintudas@gmail.com','state_id'=>19,'organisation_id'=>1]);
